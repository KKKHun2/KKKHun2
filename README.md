...
<br />
진행한 프로젝트로 LG Enact 기반의 TV/WebOS 개발 경험과 기존 JSP 기반의 서비스를 React로 마이그레이션한 경험을 바탕으로, 레거시 시스템 개선과 모던 프런트엔드 구축 모두에 강점을 갖고 있습니다.<br />
<br />
또한 소규모 진행이긴 했으나 대기업 앱 프로젝트를 프론트 개발 리더로서 주도한 경험이 있으며,<br />
